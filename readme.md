...
| 4  | ADD         | Add two values                                   | Arithmetic    | Reg or literal       |
| 5  | SUB         | Subtract two value                               | Arithmetic    | Reg or literal       |
| 6  | MUL         | Multiply two value                               | Arithmetic    | Reg or literal       |
| 7  | DIV         | Divide two value                                 | Arithmetic    | Reg or literal       |
| 8  | MOD         | Modulo two value                                 | Arithmetic    | Reg or literal       |
| 9  | INC         | Increment a Register value                       | Arithmetic    | Reg                  |
| 10 | DEC         | Decrement a Register value                       | Arithmetic    | Reg                  |
| 11 | AND         | Bitwise AND between two registers values         | Arithmetic    | Reg                  |
| 12 | OR          | Bitwise OR between two registers values          | Arithmetic    | Reg                  |
| 13 | XOR         | Bitwise XOR between two registers values         | Arithmetic    | Reg                  |
| 15 | NOT         | Bitwise NOT between two registers values         | Arithmetic    | Reg                  |
| 16 | CMP         | Compare two values and update flags              | Comparison    | Reg or literal       |
| 17 | JMP         | Unconditional Jump to  memory address            | Control Flow  | Reg or literal       |
| 18 | JZ          | Jump if Zero to  memory address                  | Control Flow  | Reg or literal       |
| 19 | JNZ         | Jump if Not Zero to  memory address              | Control Flow  | Reg or literal       |
| 20 | JN          | Jump if Negative to  memory address              | Control Flow  | Reg or literal       |
| 21 | JNN         | Jump if Not Negative to  memory address          | Control Flow  | Reg or literal       |
| 22 | JC          | Jump if Carry to  memory address                 | Control Flow  | Reg or literal       |
| 23 | JNC         | Jump if Not Carry to  memory address             | Control Flow  | Reg or literal       |
| 24 | CALL        | Subroutine Call                                  | Control Flow  | Literal              |
| 25 | RET         | Subroutine Return                                | Control Flow  | None                 |
